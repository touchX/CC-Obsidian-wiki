...
| # | 专题 | 章节数 | 大小 | 核心内容 |
|---|------|--------|------|----------|
| 01 | [01-overview](./01-overview.md) | 7 节 | 35KB | 技术栈、6 条核心设计原则、9 阶段启动流程 |
| 02 | [02-agent-loop](./02-agent-loop.md) | 5 节 | 27KB | Agent 循环双层架构、7 种故障恢复、工具预执行 |
| 03 | [03-context-engineering](./03-context-engineering.md) | 6 节 | 69KB | 4 级压缩流水线、自动恢复机制、提示词缓存 |
| 04 | [04-tool-system](./04-tool-system.md) | 6 节 | 61KB | 66 个工具注册与并发、MCP 7 种传输 |
| 05 | [05-code-editing-strategy](./05-code-editing-strategy.md) | 4 节 | 46KB | search-and-replace、唯一性约束、抗幻觉设计 |
| 06 | [06-hooks-extensibility](./06-hooks-extensibility.md) | 5 节 | 52KB | 23+ Hook 事件、5 种 Hook 类型、6 阶段管道 |
| 07 | [07-multi-agent](./07-multi-agent.md) | 5 节 | 56KB | 子 Agent 4 种模式、Worktree 隔离、Swarm 通信 |
| 08 | [08-memory-system](./08-memory-system.md) | 5 节 | 37KB | 4 种记忆类型、语义召回、团队记忆 |
| 09 | [09-skills-system](./09-skills-system.md) | 4 节 | 27KB | 6 层优先级、懒加载、白名单权限 |
| 10 | [10-plan-mode](./10-plan-mode.md) | 5 节 | 25KB | 5 阶段工作流、附件节流、审批与恢复 |
| 11 | [11-permission-security](./11-permission-security.md) | 6 节 | 52KB | 5 层纵深防御、tree-sitter AST 23 项检查 |
| 12 | [12-user-experience](./12-user-experience.md) | 5 节 | 50KB | Ink 渲染器、Yoga Flexbox、虚拟滚动、Vim 模式 |
| 13 | [13-minimal-components](./13-minimal-components.md) | 6 节 | 59KB | 7 个最小组件、从 500 行到 50 万行演进 |
| 14 | [14-system-prompt-design](./14-system-prompt-design.md) | 8 节 | 223KB | 7 层递进架构、反模式接种、7 条设计原则 |
| 15 | [15-task-system](./15-task-system.md) | 5 节 | 24KB | 文件级存储、三层变更检测、多 Agent 协调 |
