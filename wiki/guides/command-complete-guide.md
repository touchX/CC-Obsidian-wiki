...
type: guide
tags: [commands, tutorial, claude-code, best-practices]
created: 2026-05-02
updated: 2026-05-04
source: ../../../archive/notes/2026-05-02-command-complete-guide.md
---

# Claude Code Command 完整指南

> [!tip] 重要说明
> Command 使用纯 Markdown 自然语言语法，不是 XML 标签。这是官方标准格式。
