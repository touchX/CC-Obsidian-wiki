---
name: implementation/skill-design-principles
description: Claude Skill 设计原则 — 核心原则、创建时机、Description 最佳实践
type: implementation
tags: [skills, design, principles, implementation]
created: 2026-04-27
updated: 2026-04-29
source: ../../archive/notes/2026-04-27-skill-design-principles.md
---
...
| 不要 | 原因 |
|------|------|
| ❌ 写显而易见的编程概念 | Claude 本身就能推理出来 |
| ❌ 把 Skill 当 CLAUDE.md 用 | 作用域和触发方式不同 |
| ❌ Description 写实现细节 | 应该是触发条件而非功能描述 |
| ❌ 创建只用一次的技能 | 浪费维护成本 |
| ❌ 把事实性内容写成 Skill | 事实应放 CLAUDE.md |
| ❌ 忽略 Gotchas | Gotchas 是区分好 Skill 的关键 |
...
- [[entities/claude-skills]] — 技能系统完整参考
- [[resources/github-repos/mattpocock-skills]] — Matt Pocock 技能集合
- [[tips/skills-lessons]] — Thariq 九大经验
