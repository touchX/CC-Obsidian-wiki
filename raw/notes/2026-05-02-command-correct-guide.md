...
> 本文档介绍 Claude Code Commands 的正确语法和使用方法。
> 创建时间: 2026-05-02
> 更新时间: 2026-05-02（修正严重语法错误）
...
- [Commands 模块学习](./progress-commands.md)
- [Agent/Command/Skill 对比](../wiki/synthesis/agent-command-skill-comparison.md)
- [Commands 实现指南](../wiki/guides/commands.md)
