---
name: thariq-skills-9-types
description: Thariq分享Anthropic内部使用Skills的9种类型与9个最佳实践，包括Library Reference、Product Verification、CI/CD、Runbooks等分类
type: source
tags: [tips, thariq, skills, best-practices, types, categories]
created: 2026-03-17
source: tips/claude-thariq-tips-17-mar-26.md
---

# Lessons from Building Claude Code: How We Use Skills — Thariq

> Thariq分享Anthropic内部使用Skills的9种类型与9个最佳实践，包括Library Reference、Product Verification、CI/CD、Runbooks等分类，以及Gotchas Section、Description触发机制等实战技巧。
