---
name: notes/2026-05-02-agent-skill-architecture-insight
description: Agent/Skill 架构的通才与专才设计模式
type: tips
tags: [session, insight, agents, skills, architecture]
created: 2026-05-02
source: conversation
related:
...
└─────────────────────────────────────────────────────────────┘
        ...
        │ code-    │   │dependen-│   │ doc-    │
        │ explainer│   │cy       │   │generator│
        ├──────────┤   ├──────────┤   ├──────────┤
        │ 专精:    │   │ 专精:    │   │ 专精:    │
        │ 代码结构  │   │ 依赖分析  │   │ 文档生成  │
        │          │   │          │   │          │
        │ 内部Agent│   │ 内部Agent│   │ 内部Agent│
        │ 决定渠道  │   │ 决定渠道  │   │ 决定渠道  │
        └──────────┘   └──────────┘   └──────────┘
```
...
- [[guides/commands]] — Commands 实现指南
- [[guides/subagents]] — Subagents 实现
