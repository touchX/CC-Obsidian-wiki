---
name: agent-command-skill-comparison
description: Agent/Command/Skill 三种扩展机制对比分析 — 何时使用哪种
type: synthesis
...
> **相关**: [[entities/claude-commands]] | [[entities/claude-skills]] | [[concepts/agent-harness]]
...
- [Skills Best Practice](../archive/best-practice/claude-skills.md)
- [Commands Best Practice](../archive/best-practice/claude-commands.md)
- [Sub-agents Best Practice](../archive/best-practice/claude-subagents.md)
