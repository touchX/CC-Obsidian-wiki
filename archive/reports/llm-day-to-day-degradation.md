---
name: llm-degradation-analysis
description: LLM 日间性能波动分析 — 真实原因 vs 认知偏差
type: source
...
> **相关**: [[concepts/context-management]] | [[entities/claude-commands]] (/model)
...
<table width="100%">
<tr>
<td width="50%"><a href="https://x.com/nicksdot/status/2029520949176049704"><img src="../!/images/reports/llm-degradation.png" alt="Twitter users reporting day-to-day Claude quality degradation" width="100%" /></a></td>
<td width="50%"><a href="https://x.com/levelsio/status/2029369159893569680"><img src="../!/images/reports/llm-degradation-2.png" alt="Twitter users reporting day-to-day Claude quality degradation" width="100%" /></a></td>
</tr>
</table>
