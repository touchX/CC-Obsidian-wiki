...
description: API 级别工具调用优化 — PTC、动态过滤、Tool Search 节省 37%+ token
type: source
...
> **相关**: [[entities/claude-cli-startup-flags]] | [[concepts/context-management]]
...
<img src="../!/images/reports/programmatic-tool-calling-diagram.svg" alt="PTC Diagram — Traditional vs Programmatic Tool Calling" width="100%" />
