...
description: Claude Code 架构深度解析 — Harness 为何不是提示词包装器
type: synthesis
...
> **相关**: [[entities/claude-commands]] | [[entities/claude-skills]] | [[entities/claude-subagents]] | [[concepts/agent-harness]]
...
- [Claude Memory Best Practice](../archive/best-practice/claude-memory.md) — lazy-loaded descendant `CLAUDE.md` files
- [Claude Subagents Best Practice](../archive/best-practice/claude-subagents.md) — frontmatter reference for harness-enforced capabilities
- [Claude Settings Best Practice](../archive/best-practice/claude-settings.md) — permission rule evaluation and `auto` mode classifier
