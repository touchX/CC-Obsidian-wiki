---
name: day0-linux-setup
description: Linux 平台 Claude Code 安装指南 — fnm/nodejs.org 官方推荐方式
type: guide
tags: [tutorial, setup, linux, installation, nodejs, fnm, ubuntu, debian, fedora, arch]
created: 2026-04-26
source: tutorial/day0/linux.md
---

# Linux Setup

> 50-100字中文摘要：Linux 平台 Claude Code 安装指南，推荐使用 fnm（Fast Node Manager）管理 Node.js 版本。同时提供系统包管理器（apt/dnf/pacman）和 NodeSource 两种备选方案。包含 WSL 兼容说明和 PATH 问题排查。
