---
name: day1-usage-levels
description: Claude Code 使用层级指南 — Prompting → Agents → Skills 三级模式
type: guide
tags: [tutorial, prompting, agents, skills, levels, workflow]
created: 2026-04-26
source: tutorial/day1/README.md
---

# Day 1 — Your First Conversation with Claude Code

> 50-100字中文摘要：Day 1 指南介绍 Claude Code 三级使用模式：Level 1 Prompting（即时问答）、Level 2 Agents（角色型预测执行）、Level 3 Skills（技能型精确控制）。以天气数据获取为例，演示从随意提问到专业工作流的演进过程。
...
- [[entities/claude-skills]] — Skills 系统详解
- [[guides/power-ups]] — Claude Code 增强功能
- [[tutorial/day0/README]] — Day 0 安装指南
