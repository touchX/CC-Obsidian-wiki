---
name: commands-implementation
description: Claude Code Commands 命令系统实现详解 — 天气编排器示例
type: guide
tags: [implementation, commands, orchestration, weather-orchestrator]
created: 2026-03-02
source: claude-commands-implementation.md
---

# Commands Implementation

> 50-100字中文摘要：Commands 是 Claude Code 的命令入口点，通过 YAML frontmatter 定义元数据，支持 `/command` 触发。Weather Orchestrator 命令展示了 Command → Agent → Skill 架构模式的多步工作流编排实现。
...
<a href="#weather-orchestrator"><img src="archive/assets/tags/implemented-hd.svg" alt="Implemented"></a>
