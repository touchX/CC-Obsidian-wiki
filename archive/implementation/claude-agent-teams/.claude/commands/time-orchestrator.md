---
name: commands/time-orchestrator
description: 时间编排命令 — 获取迪拜时间并生成可视化 SVG 时间卡
type: command
tags: [commands, time, orchestration, svg]
created: 2026-04-25
---

# Time Orchestrator Command

获取迪拜当前时间并生成可视化 SVG 时间卡的双步骤编排命令。

## 交叉引用

- [[agents/time-agent]] — 时间获取 Agent
- [[skills/time-svg-creator]] — SVG 生成器
