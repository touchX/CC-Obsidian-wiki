---
name: skills-implementation
description: Claude Code Skills 系统实现详解 — Agent Skills 与 Skills 两种调用模式
type: guide
tags: [implementation, skills, agent-skills, invocation-patterns]
created: 2026-03-02
source: claude-skills-implementation.md
---

# Skills Implementation

> 50-100字中文摘要：Skills 展示了两种调用模式——Agent Skills（预加载）和 Skills（直接调用）。Weather SVG Creator 技能演示了 Command → Agent → Skill 架构模式中的 Skill 层实现，支持 SVG 生成等创意任务。
...
<a href="#weather-svg-creator"><img src="archive/assets/tags/implemented-hd.svg" alt="Implemented"></a>
