...
description: Claude Code 75 个内置斜杠命令完整参考 — 按类别分类
type: entity
tags: [commands, slash-commands, cli, reference]
created: 2026-04-18
updated: 2026-04-18
sources: 3
---
...
[![Implemented](https://img.shields.io/badge/Implemented-2ea44f?style=flat)](../archive/implementation/claude-commands-implementation.md)

Claude Code commands — frontmatter fields and official built-in slash commands.

> **相关概念**: [[entities/claude-cli-startup-flags]] | [[entities/claude-skills]] | [[concepts/agent-harness]]
...
## ![Official](../assets/tags/official.svg) **(75)**
